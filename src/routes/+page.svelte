<script>
 ...
 import { bettingSites } from '$src/bettingSites.js';
...
.link-container {
  ...
  .link-item {
    display: flex;
    flex-direction: row; /* Place link and bonus info side by side */
    align-items: center;
    gap: 0.5rem; /* Space between link and bonus info */
